...
export default function KoleksiBukuPage() {
  ...
  useEffect(() => {
    fetch("/api/books")
      ...
      .then((data) => {
        ...
        setBooks(normalised);
        setBookStock(getDBStock(normalised));
        setLoading(false);
      })
  ...
  useEffect(() => {
    ...
    setWishlist(saved.filter(b => b.username === currentUsername));
  }, []);
  ...
  const toggleWishlist = (book) => {
    ...
    if (existsIndex >= 0) {
      ...
      updatedAll = [...allSaved, { kode_buku: book.kode_buku, title: book.judul, author: book.pengarang, cover: book.gambar || null, stock: bookStock[book.kode_buku] ?? 0, username: currentUsername }];
    }
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white w-full max-w-md p-6 rounded-xl shadow-lg">
            ...
            <div className="mb-4">
              ...
              <input type="text" className="w-full p-3 border rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed"
